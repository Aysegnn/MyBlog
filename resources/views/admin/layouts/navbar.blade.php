        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse  aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item "    href="{{route('article.index')}}">Makaleler</a>
                    <a class="collapse-item " href="{{route('article.create')}}">Makale Oluştur</a>
                </div>
            </div>
        </li>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="mr-2 d-none d-lg-inline text-gray-600 small">Ayşe Gönen</span>
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a target="_blank" href="{{route('user.homepage')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
